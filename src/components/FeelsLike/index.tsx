...
export default function FeelsLike() {
  ...
  const currentTemperature = useAppSelector(
    (state) => state.weather.now.temperature,
  );
          ...
          <>
            ...
            <article
              ...
              style={
                {
                  "--color":
                    difference.comparison == "less" ? "#49b8b7ff" : "#E6643B",
                  "--beforePosition":
                    difference.comparison == "less" ? "99.5%" : "0",
            ...
            <p className="description">
              По ощущениям{" "}
              {difference.comparison == "less"
                ? "прохладнее из-за ветра"
                : "теплее из-за влажности"}
            </p>
          </>
        )}
      </div>
